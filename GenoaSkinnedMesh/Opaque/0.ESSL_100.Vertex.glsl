...
void main ()
{
  ...
  v_texcoord0 = uv_8;
  v_viewSpacePosition = (u_view * tmpvar_21);
  v_color0 = a_color0;
  v_viewSpaceNormal = (u_modelView * tmpvar_20).xyz;
  v_worldSpacePosition = tmpvar_22;
  v_fog = tmpvar_19;
  v_light = tmpvar_6;
