...
void main ()
{
  ...
  tmpvar_12 = (model_10 * tmpvar_11).xyz;
  highp vec4 tmpvar_13;
  tmpvar_13.w = 1.0;
  tmpvar_13.xyz = tmpvar_12;
  tmpvar_9 = (u_viewProj * tmpvar_13);
  highp vec4 tmpvar_14;
  tmpvar_14.w = 1.0;
  tmpvar_14.xyz = tmpvar_2;
  highp vec3 tmpvar_15;
  tmpvar_15 = (PlayerPosition.xyz - (World * tmpvar_14).xyz);
  highp float tmpvar_16;
  tmpvar_16 = (sqrt(dot (tmpvar_15, tmpvar_15)) / FogControl.z);
  highp float tmpvar_17;
  tmpvar_17 = (FogControl.y - FogControl.x);
  highp float tmpvar_18;
  tmpvar_18 = sign(tmpvar_17);
  highp float tmpvar_19;
  if ((tmpvar_18 > 0.0)) {
    tmpvar_19 = sign(tmpvar_17);
  } else {
    tmpvar_19 = 0.0;
  };
  highp vec4 tmpvar_20;
  tmpvar_20.xyz = FogColor.xyz;
  tmpvar_20.w = (tmpvar_19 * clamp ((
    (tmpvar_16 - FogControl.x)
   / tmpvar_17), 0.0, 1.0));
  highp vec4 tmpvar_21;
  tmpvar_21.w = 0.0;
  tmpvar_21.xyz = a_normal.xyz;
  ...
  v_viewSpacePosition = (u_view * tmpvar_22);
  v_texcoord0 = uv_8;
  v_color0 = a_color0;
  v_viewSpaceNormal = (u_modelView * tmpvar_21).xyz;
  v_worldSpacePosition = tmpvar_23;
  v_fog = tmpvar_20;
  v_light = tmpvar_6;
